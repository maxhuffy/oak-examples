...
file_path = "bgr888i_stream.pkl"
if not os.path.exists(file_path):
    print("Prerecorded stream not found, downloading...")
    GoogleDownloader.download(
        "https://drive.google.com/file/d/1wb72mTFb7kWhxC3zcJRkxZ7P_7-b-kX4/view?usp=drive_link",
        file_path
    )
visualizer = dai.RemoteConnection()
stream_queue = visualizer.addTopic("BGR888i Stream")
...
try:
    ...
    visualizer.removeTopic("BGR888i Stream")
    reader.close()
