...
function App() {
    ...
    return (
        <main className={css({
            ...
            {/* Left: Stream Viewer */}
            <div
                className={css({flex: 1, minWidth: 0, position: 'relative', overflow: 'hidden'})}
            ...
            <div
                className={css({
                    // fixed but adjustable range; won’t collapse
                    width: '420px',
                    minWidth: '340px',
                    maxWidth: '520px',
                    flexShrink: 0,
                    ...
                    // vertical scroll for the panel content
                    overflowY: 'auto',
                    // ensure full viewport height for the scroll area
                    height: '100vh',

                    // slight padding so scrollbars don’t sit on content
                    pr: 'sm',
                })}
            >
