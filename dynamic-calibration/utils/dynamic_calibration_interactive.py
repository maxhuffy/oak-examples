...
with pipeline:
    ...
    while True:
        ...
        if calibration_result and calibration_result.calibrationData:
            ...
            command_input.send(
                dai.DynamicCalibrationControl(
                    dai.DynamicCalibrationControl.Commands.ApplyCalibration(new_calibration)
                )
            )
        ...
        if key == ord('c'):
            depthDiff = []
            command_input.send(dai.DynamicCalibrationControl(dai.DynamicCalibrationControl.Commands.LoadImage()))
            command_input.send(dai.DynamicCalibrationControl(dai.DynamicCalibrationControl.Commands.CalibrationQuality(True)))
            ...
            command_input.send(dai.DynamicCalibrationControl(dai.DynamicCalibrationControl.Commands.Calibrate(True)))
            state = "Recalibration"
            finalDisplay = True
            ...
            command_input.send(dai.DynamicCalibrationControl(dai.DynamicCalibrationControl.Commands.ApplyCalibration(calibNew)))
            ...
            command_input.send(dai.DynamicCalibrationControl(dai.DynamicCalibrationControl.Commands.ApplyCalibration(calibOld)))
